                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('blogupdate', $blogs->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <input type="hidden" name="old_picture" id="old_picture" value="{{ $blogs->picture }}">
                            ...
                            <div>
                                ...
                                <img src="{{ asset($blogs->picture) }}" alt="img" width="350" height="300"> <br><br>
                            </div>
                            <div class="center">
